            ...
            <tbody className="divide-y divide-slate-100">
              {products.map((p) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-xs text-secondary-foreground font-medium">
                    {p?.categoryId?.name}
                  </td>
                  ...
                  <td className="px-4 py-4 text-right">
                    <div className="flex items-center justify-end">
                      <button
                        className="p-1 hover:bg-bg-surface text-text-secondary hover:text-text-primary rounded-lg transition-all"
                        title="Edit Product"
                      ...
                      <button
                        className="p-1 hover:bg-red-50 text-text-secondary hover:text-red-600 rounded-lg transition-all"
                      ...
                      <button
                        className="p-1.5 hover:bg-red-50 text-text-secondary hover:text-green-600 rounded-lg transition-all"
                        title="View Product"
