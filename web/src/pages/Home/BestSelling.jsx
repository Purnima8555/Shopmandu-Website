...
export default function BestSelling() {
  const getBestSellingProducts = useProductStore((state) => state.getBestSellingProducts);
  const bestSellingProducts = useProductStore((state) => state.bestSellingProducts);
