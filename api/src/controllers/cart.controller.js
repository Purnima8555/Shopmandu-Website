...
export const updateCartItem = async (req, res, next) => {
  try {
    ...
    const cart = await cartService.updateCartItemService(req.user._id, req.params.productId, quantity);
...
export const removeCartItem = async (req, res, next) => {
  try {
    const cart = await cartService.removeCartItemService(req.user._id, req.params.productId);
