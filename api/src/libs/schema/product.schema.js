    ...
    z.preprocess((value) => {
        if (typeof value === "string") {
            ...
            try {
                ...
                if (Array.isArray(parsed)) { //// it applies => ["red", "blue"]
...
const updateProductSchema = z.object({
    ...
    slug: z.string()
        ...
        .optional(),
    productStatus: z
        .enum([productStatus.ACTIVE, productStatus.INACTIVE, productStatus.OUT_OF_STOCK]).optional(),
    shortDescription: z
        .string()
        .trim()
        .optional(),
    ...
    stock: z.coerce
        ...
        .gte(0)
        .optional(),
    colors: formArray(z.string())
        .optional(),
    sizes: formArray(z.string())
        .optional(),
    brand: z
        .string()
        .trim()
