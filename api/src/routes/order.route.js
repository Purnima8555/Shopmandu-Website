...
router.get("/vendor/sales-trend", auth, roleBasedAuth(Roles.VENDOR_ROLE), getVendorSalesTrend);

router.get("/admin/sales-summary", auth, roleBasedAuth(Roles.ADMIN_ROLE), getAdminSalesSummary);

router.get("/admin/sales-trend", auth, roleBasedAuth(Roles.ADMIN_ROLE), getAdminSalesTrend);
